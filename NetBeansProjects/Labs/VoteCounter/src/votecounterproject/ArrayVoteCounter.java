...
public class ArrayVoteCounter {
    ...
    /**
     * Create new ArrayVoteCounter object to collect election data
     */
    ...
    public void reportResults() {
        ...
        for (SithSenateMember sithSenateMember : sithSenateMembers) {
            System.out.println("Darth " + sithSenateMember.getSurname() + ": " 
                    + getMemberVotes(sithSenateMember.getFullName())
                    + " votes, " + df.format(sithSenateMember.getNumVotes() / 
                            (float) validVotes * 100) + "%.");
        }
        System.out.println("There were " + spoiledVoteIndex + 
                " spoiled votes.");
    }
    ...
    /**
     * Generate random election data after shuffling the candidate array.
