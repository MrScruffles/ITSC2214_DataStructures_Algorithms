...
/**
 * Class ConcertTicket that stores the name of a concert, the price, and the date.
 * @author clatulip, mapq
 * @version 1
 */
public class ConcertTicket implements Comparable<ConcertTicket> {
    ...
    public int compareTo(ConcertTicket ct) {
        ...
        // Use a threshold for comparing doubles
        double threshold = 0.0001;
        if(Math.abs(this.price - ct.price) < threshold) {
            return 0;
